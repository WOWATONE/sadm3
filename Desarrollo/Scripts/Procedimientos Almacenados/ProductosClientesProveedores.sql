...
BEGIN
	...
	SET NOCOUNT ON;
	 ...
	 INSERT INTO producto
			...
			(desc_prod, c_interno, cliente_nombre, desc_com, precio,
			 factor, pesoneto, precioinven, peso, material_codigo1,
			 porc1, material_codigo2, porc2, eficiencia, ciclo,
			 estado, c_cliente, linea, nivelrevision, maquina,
			 foto, num_orden, aql, caducidad, plandecontrol,
			 cavidad, minmen, niving, opmaq, fa,
			 molde, stockmin, stockmax, codigodibujo, e_bolsa,
			 e_loteb, e_caja, e_lotec, e_lote, comen,
			 ban4, fec_alta, mod_alta, usu_alta)
